...
class TestExpense:
    ...
    def testInitBadYear(self):
        Expense(2012, 4, 20, "Dana", 10.50, "Trucs...")

    @raises(ValueError)
    def testInitBadMonth(self):
        Expense(2013, 0, 20, "Dana", 10.50, "Trucs...")

    @raises(ValueError)
    def testInitBadDay(self):
        Expense(2013, 12, 32, "Dana", 10.50, "Trucs...")

    @raises(TypeError)
    def testInitBadNameType(self):
        Expense(2013, 4, 20, 123, 10.50, "Trucs...")

    @raises(ValueError)
    def testInitEmptyName(self):
        Expense(2013, 4, 20, "", 10.50, "Trucs...")

    @raises(ValueError)
    def testInitBadAmount(self):
        Expense(2013, 4, 20, "Dana", -10.50, "Trucs...")

    @raises(ValueError)
    def testInitNullAmount(self):
        Expense(2013, 4, 20, "Dana", 0, "Trucs...")

    @raises(TypeError)
    def testInitBadDescriptionType(self):
        Expense(2013, 4, 20, "Dana", 0.1, 123)

    @raises(ValueError)
    def testInitEmptyDescription(self):
        Expense(2013, 4, 20, "Dana", 0.1, "")
